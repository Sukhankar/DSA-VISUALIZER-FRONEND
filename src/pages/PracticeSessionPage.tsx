...
export const PracticeSessionPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    problemService
      ...
      .then((det) => {
        ...
        setCode(savedCode || getStarterTemplate(det.slug, selectedLanguage));
      })
  ...
  const handleLanguageChange = (lang: string) => {
    ...
    if (session && currentProblemDetail) {
      ...
      setCode(savedCode || getStarterTemplate(currentProblemDetail.slug, lang));
    }
  };
        ...
        <div className="lg:col-span-6 space-y-4">
          <Card className="bg-slate-900/90 border-slate-800 space-y-4 overflow-hidden p-0">
            ...
            <div className="flex items-center justify-between px-4 py-3 bg-slate-950 border-b border-slate-800">
              ...
              <button
                onClick={() => setCode(currentProblemDetail ? getStarterTemplate(currentProblemDetail.slug, selectedLanguage) : '')}
